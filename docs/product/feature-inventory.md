...
| Editor e exportação de convites | Operacional | Possui dois módulos alternáveis, Convidado (`convite_owntime`) e Owner (`convite_owner`, baseado no Frame 2 de 1448 × 4234 do Figma), ambos com campos editáveis, imagem, histórico, CRUD e exportação pelo PDF do navegador. O Owner usa capa, logo, ícones, fonte Raleway local e página de impressão longa próprios. `public/cards-pos.html`, `public/cards-pos/app.js`, `public/cards-pos/assets/owner/` |
