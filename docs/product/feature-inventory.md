...
| Editor e exportação de convites | Operacional | Possui dois módulos alternáveis, Convidado (`convite_owntime`) e Owner (`convite_owner`, baseado no frame 2 do Figma), ambos com campos editáveis, imagem, histórico, CRUD e exportação pelo PDF do navegador. `public/cards-pos.html`, `public/cards-pos/app.js` |
